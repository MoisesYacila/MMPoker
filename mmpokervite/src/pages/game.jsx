...
import {
    ...
    TableRow, Button, Stack, Collapse, Alert, IconButton
} from '@mui/material';
...
export default function Game() {
    ...
    return (
        <div>
            {/* Alert to show if deletion or edit fails. Syntax from MUI */}
            <Collapse in={openAlert}>
                <Alert severity='error' action={
                    ...
                    Must be signed in to edit or delete games.
                </Alert>
            </Collapse>
